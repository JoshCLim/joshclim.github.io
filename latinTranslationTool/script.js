...
database.ref('/translationText/').child(referenceWord).on('value', function(results) {
  ...
  /*for (var q in $('#translation-wrapper').children) {
    console.log ($('#translation-wrapper').children[q])
    
    //if ('\n' in $('#translation-wrapper').children()[q].html()) {
      $('#translation-wrapper').children[q].addClass('number').attr('line-number', q)
    //}
  }*/
  ...
  if (referenceWord == 'Bk12Aeneid 614-696') {
    lineNumber = 614;
  } else if (referenceWord == 'Bk12Aeneid 697-765') {
    lineNumber = 697;
  } else if (referenceWord == 'Bk12Aeneid 766-790') {
    lineNumber = 766;
  } else if (referenceWord == 'Bk12Aeneid 791-842') {
    lineNumber = 791;
  } else if (referenceWord == 'Bk12Aeneid 843-886') {
    lineNumber = 843;
  } else if (referenceWord == 'Bk12Aeneid 887-952') {
    lineNumber = 887;
  } 

  $("#translation-wrapper").children().each(function() {

    //console.log($(this).position().top)

    //console.log($(this).text())

    if ($(this).position().top > offset && $(this).text() != ' ') {

      offset = $(this).position().top

      $(this).attr('line-number', lineNumber)
